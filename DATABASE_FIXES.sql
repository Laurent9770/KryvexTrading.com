-- =====================================================
-- DATABASE FIXES FOR KRYVEX TRADING PLATFORM
-- =====================================================
...
-- 8. Create RLS policies for wallet_transactions
...
-- 10. Create RLS policies for withdrawals
...
AND tablename IN ('profiles', 'wallet_transactions', 'transactions', 'withdrawals')
