-- Simple setup script for Kryvex Trading
...
-- Insert sample trading pairs (simple insert without conflict handling)
...
-- Insert sample staking pools (simple insert without conflict handling)
