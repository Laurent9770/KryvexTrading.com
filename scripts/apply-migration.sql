-- =====================================================
-- APPLY ADMIN & WALLET SYSTEM MIGRATION
-- =====================================================
...
-- 5) Drop existing is_admin function if it exists (to avoid parameter name conflicts)
drop function if exists public.is_admin(uuid);

-- 6) Create unified is_admin function
...
select count(*) as wallet_transactions_count from public.wallet_transactions;
select count(*) as admin_actions_count from public.admin_actions;
