-- Single Comprehensive Admin Setup Migration
...
CREATE TABLE IF NOT EXISTS public.trades (
  ...
  result TEXT CHECK (result IN ('pending', 'win', 'loss', 'draw')),
...
-- 5. Create basic RLS policies for users
...
-- 12. Insert sample data for existing users
