...
-- Step 5: Drop and recreate policies to ensure they work with new columns
...
-- Step 8: Migrate data from other tables if not already done
DO $$
DECLARE
